...
const CSRF_EXEMPT = ["/api/paystack/webhook", "/api/stitch/webhook", "/api/whatsapp/webhook", "/api/cron/", "/api/tips", "/api/contact", "/api/apply", "/api/qrcodes/activate", "/api/auth/login", "/api/auth/register", "/api/auth/forgot-password", "/api/auth/reset-password", "/api/auth/otp/", "/api/auth/2fa/verify", "/api/auth/csrf", "/api/auth/logout", "/api/health"];
